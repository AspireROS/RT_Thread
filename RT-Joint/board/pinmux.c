...
void init_led_pins(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PD06].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(0);

    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOD, 6, gpiom_soc_gpio0);
    gpio_set_pin_output(HPM_GPIO0, GPIO_OE_GPIOD, 6);
    gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOD, 6, 0);

    HPM_IOC->PAD[IOC_PAD_PD07].FUNC_CTL = IOC_PD07_FUNC_CTL_GPIO_D_07;
    HPM_IOC->PAD[IOC_PAD_PD07].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(0);

    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOD, 7, gpiom_soc_gpio0);
    gpio_set_pin_output(HPM_GPIO0, GPIO_OE_GPIOD, 7);
    gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOD, 7, 0);
}
